...
<table class="wp-list-table widefat fixed striped">
    ...
    <tbody>
        <?php if(!empty($lich_su)): foreach($lich_su as $ls):
            ...
            $row_bg = ($ls->trangThai === 'Chưa nhắn Zalo') ? 'background-color: #fff3cd;' : '';

            preg_match('/[0-9]{2}\/[0-9]{2}\/[0-9]{4}/', $ls->ghiChu, $matches);
            $ngay_in_tin_nhan = !empty($matches) ? $matches : 'tháng sau';
            ...
            <tr style="<?php echo $row_bg; ?>">
                ...
                <td>
                <?php
                if ($ls->trangThai === 'Chưa nhắn Zalo') {
                ...
                } elseif ($ls->trangThai === 'Đã nhắn Zalo') {
                    include QLBH_PATH . 'views/partials/lich-su-form-thu-nhanh.php';
                } elseif ($ls->trangThai === 'Chờ kết quả BHXH') {
                ...
                <td><?php echo esc_html($ls->ghiChu); ?></td>
            </tr>
